...
Java_com_rfandango_haku_1x_XboxHddFormatter_00024NativeBridge_nativeInspectHdd(
...
Java_com_rfandango_haku_1x_XboxHddFormatter_00024NativeBridge_nativeInitializeHdd(
...
Java_com_rfandango_haku_1x_XboxInsigniaHelper_00024NativeBridge_nativeInspectDashboardFlags(
...
JNIEXPORT void JNICALL
Java_com_rfandango_haku_1x_XboxInsigniaHelper_00024NativeBridge_nativeApplyConfigSectorDns(
        JNIEnv *env,
        jobject obj,
        jstring jhdd_path,
...
JNIEXPORT void JNICALL
Java_com_rfandango_haku_1x_XboxDashboardImporter_00024NativeBridge_nativeImportDashboard(
